...
public sealed class CharacterTagAuditIntegrationTests
{
    ...
    [Fact]
    public void ProjectPublishesAgentSkillsAndVersionIs111()
    {
        ...
        Assert.Contains("<ApplicationVersion>1.1.1.0</ApplicationVersion>", csproj);
        Assert.Contains("AssemblyVersion(\"1.1.1.0\")", assembly);
        Assert.Contains("AssemblyFileVersion(\"1.1.1.0\")", assembly);
        Assert.Contains("AssemblyInformationalVersion(\"1.1.1\")", assembly);
    }
