...
namespace BooruDatasetTagManager
{
    public partial class Form_addTag : Form
    {
        ...
        public Form_addTag()
        {
            ...
            tagTextBox.Values = Program.ChineseTagLookup.CreateAutocompleteValues(Program.TagsList.Tags, Program.Settings.Language);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                tagTextBox.Text = Program.ChineseTagLookup.ResolveInput(tagTextBox.Text, Program.Settings.Language);
